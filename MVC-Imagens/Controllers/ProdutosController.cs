...
namespace Mvc_Imagem.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var categorias = db.Categorias.Select(r => r.CategoriaId);
            var viewModel = new ProdutoViewModel
            {
                CategoriaLista = new SelectList(categorias)
            };
        ...
        public ActionResult Create(ProdutoViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    produto.Imagem = String.Format("/Imagens/{0}{1}", imagemNome, extensao);
                    // Salva imagem 
        ...
        // POST: Produtos/Delete/ProdutoID
        ...
        // GET: Produtos/Details/ProdutoID
        public ActionResult Details(int? id)
        {
            ...
            ViewBag.Categorias = db.Categorias.Find(produto.CategoriaId).CategoriaNome;
            return View(produto);
        }
